...
juce_add_gui_app(BorisGranularStation
  # VERSION ...                       # Set this if the app version is different to the project version
  # ICON_BIG ...                      # ICON_* arguments specify a path to an image file to use as an icon
  # ICON_SMALL ...
  # DOCUMENT_EXTENSIONS ...           # Specify file extensions that should be associated with this app
  COMPANY_NAME "glesdora"            # Specify the name of the app's author
  PRODUCT_NAME "Boris Granular Station")    # The name of the final executable, which can differ from the target name

target_compile_definitions(BorisGranularStation PRIVATE ${COMMON_BUILD} ${STANDALONE_DEFINITION})
...
juce_generate_juce_header(BorisGranularStation)
...
target_sources(BorisGranularStation
  PRIVATE
  src/Main.cpp
...
if (EXISTS ${RNBO_BINARY_DATA_FILE})
  target_sources(BorisGranularStation PRIVATE ${RNBO_BINARY_DATA_FILE})
endif()

target_include_directories(BorisGranularStation
  PRIVATE
  ${RNBO_CPP_DIR}/
  ${RNBO_CPP_DIR}/src
  ${RNBO_CPP_DIR}/common/
...
target_compile_definitions(BorisGranularStation
  ...
  JUCE_APPLICATION_NAME_STRING="$<TARGET_PROPERTY:BorisGranularStation,JUCE_PRODUCT_NAME>"
  JUCE_APPLICATION_VERSION_STRING="$<TARGET_PROPERTY:BorisGranularStation,JUCE_VERSION>")
...
target_link_libraries(BorisGranularStation
  PRIVATE
  juce::juce_gui_extra
...
install(TARGETS BorisGranularStation
        RUNTIME DESTINATION ".")