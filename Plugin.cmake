...
juce_add_plugin(BorisGranularPlugin
  # VERSION ...                        # Set this if the plugin version is different to the project version
  # ICON_BIG ...                       # ICON_* arguments specify a path to an image file to use as an icon for the Standalone
  # ICON_SMALL ...
  COMPANY_NAME "Glesdora"     # Specify the name of the plugin's author
  ...
  PLUGIN_MANUFACTURER_CODE "GLSD"      # A four-character manufacturer id with at least one upper-case character
  PLUGIN_CODE "B0Gr"                   # A unique four-character plugin id with at least one upper-case character
  FORMATS ${PLUGIN_FORMATS}            # The formats to build. Other valid formats are: AAX Unity VST AU AUv3
  PRODUCT_NAME "BorisGranular"          # The name of the final executable, which can differ from the target name
)


# Apply the VST3 definition only for the VST3 build
target_compile_definitions(BorisGranularPlugin PRIVATE ${COMMON_BUILD} ${VST3_DEFINITION})
...
juce_generate_juce_header(BorisGranularPlugin)
...
target_sources(BorisGranularPlugin PRIVATE
  ...
  ui/Source/RootComponent.cpp
  ui/Source/XYPad.cpp
  ui/Source/WaveVisualiserComponent.cpp
  ui/Source/EnvelopesInterpolator.cpp
  ui/Source/guicomponents/BorisGUIComp.cpp
  ui/Source/guicomponents/BorisSlider.cpp
  ui/Source/guicomponents/BorisSubPanel.cpp
...
target_include_directories(BorisGranularPlugin
  PRIVATE
  ${RNBO_CPP_DIR}/
  ${RNBO_CPP_DIR}/src
  ${RNBO_CPP_DIR}/common/
...
target_compile_definitions(BorisGranularPlugin
  PUBLIC
...
target_link_libraries(BorisGranularPlugin
  PRIVATE
